class ProviderAttachmentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @provider_attachment.save
        ...
        format.json { render :show, status: :created, location: @provider_attachment }
      else
  ...
  def update
    respond_to do |format|
      if @provider_attachment.update(provider_attachment_params)
        ...
        format.json { render :show, status: :ok, location: @provider_attachment }
      else
  ...
  private
    ...
    def provider_attachment_params
      params.require(:provider_attachment).permit(:provider_id, :image2)
    end
end
