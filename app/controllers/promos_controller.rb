class PromosController < ApplicationController
  ...
  def index
    ...
    @promos2= Promo.where(:disponible => true).order('id DESC')
  end
  ...
  def create
    ...
    respond_to do |format|
      if @promo.save
        format.html { redirect_to promos_path, notice: 'Promo was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @promo.update(promo_params)
        format.html { redirect_to promos_path, notice: 'Promo was successfully updated.' }
  ...
  private
    ...
    def promo_params
      params.require(:promo).permit(:imagen_promo, :disponible, :nombre)
    end
end
